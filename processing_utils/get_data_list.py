...
# list_path = 'data_info/train_data_patch_list.txt'
...
list_path = 'data_info/valid_data_patch_list.txt'
data_path = ['/data/cbl/clic/valid_crop_128/professional', '/data/cbl/clic/valid_crop_128/mobile']
